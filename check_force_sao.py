...
def check():
    with sync_playwright() as p:
        ...
        page.evaluate("document.querySelector('#ctl00_ContentPlaceHolder1_rbsao').click()")
        ...
        if "Bill Save Successfully" in html or "Total Amount" not in html:
            print("Force SAO actually cleared the grid and saved successfully!")
        else:
            print("Force SAO DID NOT save either! Grid is still there.")
