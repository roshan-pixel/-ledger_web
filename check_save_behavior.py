...
def check():
    with sync_playwright() as p:
        ...
        def on_dialog(dialog):
            print(f"ALERT POPUP SEEN: {dialog.message}")
            dialog.accept()
        ...
        html = page.content()
        if 'THYDOC' in html:
            print("THYDOC is in the HTML!")
        else:
            print("THYDOC is NOT in the HTML!")
        ...
        try:
            ...
            print("Network idle after save.")
        except Exception:
            pass
            
        html = page.content()
        print("Is Success in HTML? ", 'Success' in html or 'success' in html)
